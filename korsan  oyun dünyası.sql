...
CREATE TABLE IF NOT EXISTS `oyun` (
  ...
  KEY `FK_oyun_oyun_2` (`yayinci_id`),
  CONSTRAINT `FK_oyun_oyun` FOREIGN KEY (`tur_id`) REFERENCES `oyun` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `FK_oyun_oyun_2` FOREIGN KEY (`yayinci_id`) REFERENCES `oyun` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- tablo yapısı dökülüyor korsan oyun dunyası.tur
...
-- korsan oyun dunyası.tur: ~0 rows (yaklaşık) tablosu için veriler indiriliyor
/*!40000 ALTER TABLE `tur` DISABLE KEYS */;
/*!40000 ALTER TABLE `tur` ENABLE KEYS */;

-- tablo yapısı dökülüyor korsan oyun dunyası.yayinci
...
-- korsan oyun dunyası.yayinci: ~0 rows (yaklaşık) tablosu için veriler indiriliyor
